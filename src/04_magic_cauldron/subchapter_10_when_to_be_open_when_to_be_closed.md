...
TCP/IP 和 Linux 成功背后的网络效应<sup>b</sup>相当清晰，最终归结为信任和对称性问题<sup>c</sup>：共享基础设施的参与方若能看清其底层运行逻辑，自然会对这套体系更加信赖。而且他们会更倾向于让所有参与者权利对称的基础设施，而不是某一参与者处于特权地位、榨取垄断收益或单方施加控制的基础设施。
