...
实际上经验清楚地表明，趋势与此相反。开源开发的广度和数量趋势，可以通过Metalab和SourceForge（主要的 Linux 源码站点）的每日提交量，或者 freshmeat.net（一个专门发布新软件广告的站点）的每日公告量来衡量。两者的数量都在稳步快速增长。显然，"公地悲剧"模型在某个关键方面未能捕捉到实际发生的情况。
