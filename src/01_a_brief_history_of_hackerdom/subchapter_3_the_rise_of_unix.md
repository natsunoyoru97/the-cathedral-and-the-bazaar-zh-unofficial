...
除了可移植性，Unix 与 C 还有一个重要优势：二者都严格遵循“保持简单，傻瓜”的 KISS 极简设计原则。C 语言逻辑简洁干净，降低了程序员的心智负担（不像之前之后的多数其他语言），不用频繁查阅手册；而 Unix 本身由一堆小巧独立的工具程序构成，工具之间能自由拼接组合，灵活实现各类需求。

事实证明，这一组合能适应极为广泛的计算任务，包括许多设计者完全未曾预料到的任务。尽管缺乏任何正式的支持计划，它在AT&T内部传播得非常迅速。到1980年，它已传播到大量的大学和研究计算中心，成千上万的黑客将其视为自己的“家园”。
