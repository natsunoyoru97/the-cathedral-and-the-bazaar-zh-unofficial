...
8. 然而，要求领导者低调行事可能是礼物文化或者充裕文化（abundance culture）<sup>a</sup>的一种共通特征。David Christie (dc@netscape.com) 报告了一次在斐济外岛的旅行经历：
...
a. **充裕文化（abundance culture）**：与"匮乏文化"相对，指资源充裕、不以稀缺为前提的文化形态。在人类学中，此类文化往往发展出以馈赠和声望为核心的交换体系。
```
