...
顺着这个思路想就能明白：BDFL 并没有手握项目完整、排他的全部产权。虽然他有权做出具备约束力的最终决定，但本质上，他是把整体声望产权里的一部分收益份额让出去，换取其他人投入开发。用农场分佃制（sharecropping）来做类比，实在是再贴切不过了，只不过贡献者的名字会永久留在项目贡献名录，就算后来不再参与开发，也能持续拿到一点声望产权收益。
