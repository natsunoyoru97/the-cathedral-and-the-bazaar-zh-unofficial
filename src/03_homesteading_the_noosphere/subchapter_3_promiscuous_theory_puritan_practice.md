...
因此，OSD（以及遵循 OSD 的许可证，如 GPL、BSD 许可证和 Perl 的艺术许可证（Artistic License）<sup>b</sup>）背后隐含的理念是：任何人都可以二次开发任何代码。没有什么能阻止五六个不同的人拿着任一开源产品（例如，FSF 的 gcc C 编译器）、复制源代码，带着它们朝不同的演化方向各自发展，却都宣称自己的版本才是正统。
